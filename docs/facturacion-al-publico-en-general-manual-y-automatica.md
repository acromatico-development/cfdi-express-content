...
> Esta plantilla está diseñada para facturar automáticamente las órdenes pagadas y no facturadas que se generaron hace más de 3 días. Si quieres expandir el tiempo de espera deberás editar los parámetros del query de búsqueda de órdenes, es muy sencillo y puedes hacerlo en el editor de Flow. Igualmente si requieres una automatización más avanzada o que se integre con otras apps o acciones de Shopify Flow, no dudes en contactarnos a través de [Acromático Development](https://acromatico.dev).
