...
La respuesta de Shopify a todo este problema es el programa **Built for Shopify**. La idea es contar con un grupo selecto de aplicaciones que son revisadas minuciosamente por Shopify de manera recurrente, y que Shopify mismo garantiza que esa aplicación es una aplicación funciona correctamente y sobre todo es una aplicación segura y no afecta el desempeño o el funcionamiento de tu tienda.
