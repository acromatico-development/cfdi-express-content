...
- ¿Tu catálogo crece y debes administrarlo? Usa el poderoso módulo de WMS de Shopify.
- ¿Quieres surtir los pedidos y dar seguimiento del nivel de Amazón (o incluso mejor) a los mismos? Usa el módulo de ordenes de Shopify.
- ¿Quieres obtener reseñas de tus productos y opiniones de los clientes? Usa una aplicación de reseñas de la tienda de apps de Shopify.
- ¿Quieres segmentar y automatizar el marketing y los reportes? Usa el módulo de Segmentos de Shopify y las miles de apps para marketing automatizado que se conectan a Shopify
...
La configuración de la aplicación es muy sencilla y cuenta con infinidad de elementos perfectamente integrados a todo el ecosistema de Shopify, algunas de estas funcionalidades son:

- Formulario de Facturación en Checkout (Thank You Page) de Shopify con UI Extensions.
- Formulario de Facturación en Order Status Page con UI Extensions.
- Formulario de Facturación en Puntos de Venta (POS) de Shopify.
- Formulario de Facturación en Plantillas de Shopify con Theme Extensions.
- Integración con Shopify Flow para automatizaciones.
- Integración con Pixel de Shopify para analíticas.

#### ¿Qué esperas para comenzar a gestionar tu facturación electrónica CFDI en Shopify?
